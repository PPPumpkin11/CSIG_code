...
model = Model(ActionLength=60,in_channels=6,num_class=14).to(device)
# model = Model(ActionLength=60,base_channel = 256).to(device)
...
save_path ='/data/duwb/models_final/GCN_Org.pth'
